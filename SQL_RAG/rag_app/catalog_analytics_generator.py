...
Usage:
    python catalog_analytics_generator.py --csv "your_queries.csv"
    python catalog_analytics_generator.py --csv "your_queries.csv" --force-rebuild
