#!/usr/bin/env python3
"""
Data loading functionality for Modular SQL RAG Streamlit application.
"""
...
from modular.config import (
    ...
    CATALOG_ANALYTICS_DIR, SCHEMA_CSV_PATH, ENABLE_SCHEMA_MANAGER,
    ERROR_MESSAGES, INFO_MESSAGES
)
from modular.utils import parse_json_safely
...
if ENABLE_SCHEMA_MANAGER:
    try:
        # Add parent directory to path to import schema_manager
