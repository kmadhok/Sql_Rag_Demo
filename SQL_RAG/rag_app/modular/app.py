#!/usr/bin/env python3
"""
Modular SQL RAG Streamlit Application

A clean, modularized version of the SQL RAG application with three main pages:
...
# Add parent directory to Python path for imports from rag_app level
# When running from modular directory: python app.py or streamlit run app.py
parent_dir = Path(__file__).parent.parent
if str(parent_dir) not in sys.path:
    sys.path.insert(0, str(parent_dir))

# Import modular components (relative imports since we're running from modular directory)
...
def render_main_header():
    ...
    st.title("🔥 Modular SQL RAG with Gemini")
...
if __name__ == "__main__":
    try:
        ...
        from .data_loader import validate_data_files
