...
function useCurrentColorScheme(options) {
  ...
  const modeStorage = React36.useMemo(() => storageManager == null ? void 0 : storageManager({
    key: modeStorageKey,
    storageWindow
  }), [storageManager, modeStorageKey, storageWindow]);
  const lightStorage = React36.useMemo(() => storageManager == null ? void 0 : storageManager({
    key: `${colorSchemeStorageKey}-light`,
    storageWindow
  }), [storageManager, colorSchemeStorageKey, storageWindow]);
  const darkStorage = React36.useMemo(() => storageManager == null ? void 0 : storageManager({
  ...
  const [isClient, setIsClient] = React36.useState(noSsr || !isMultiSchemes);
  React36.useEffect(() => {
    setIsClient(true);
  }, []);
...
function createCssVarsProvider(options) {
  ...
  const useColorScheme = () => React37.useContext(ColorSchemeContext) || defaultContext;
  ...
  function CssVarsProvider(props) {
    ...
    const initialTheme = React37.useMemo(() => {
      if (themeProp) {
        return themeProp;
      }
    ...
    const allColorSchemes = React37.useMemo(() => joinedColorSchemes.split(","), [joinedColorSchemes]);
    ...
    const element = (0, import_jsx_runtime14.jsxs)(React37.Fragment, {
  ...
  true ? CssVarsProvider.propTypes = {
     ...
     */
    noSsr: import_prop_types19.default.bool,
    /**
     * The storage manager to be used for storing the mode and color scheme
     * @default using `window.localStorage`
     */
    storageManager: import_prop_types19.default.func,
    /**
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-TVC2CGN7.js.map
